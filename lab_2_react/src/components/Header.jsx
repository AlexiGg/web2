...
export default function Header() {
  ...
  return (
    <header className="relative bg-blue-600 text-white rounded-2xl shadow-xl overflow-hidden"
      style={{ minHeight: 220 }}>
      ...
      <div className="relative z-10 p-10 text-center">
        <h1 className="text-4xl font-extrabold mb-3">Легенчук Олександр</h1>
        <p className="text-lg">м. Львів, Україна | +380 96 910 78 22</p>
